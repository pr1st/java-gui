...
public class TurnImageParamDialog extends JDialog {
    ...
    public TurnImageParamDialog(Consumer<Integer> callback) {
        ...
        configSpinnerAndSlider(spinner, slider, -180, 180, 0);
    }

    private void onOK() {
        callback.accept((Integer)spinner.getValue());
        dispose();
    }
